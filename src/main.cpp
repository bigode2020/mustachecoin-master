...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            if(nBestHeight > 0 && nBestHeight <= 5)
            {
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        nStakeMinAge = 150 * 60 * 60; // test net min age is 1 hour
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Novo MEME crypto digital agora é Brasileiro, mustache é a coin.";
        CTransaction txNew;
        txNew.nTime = 1602173403;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1602173403;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 90563957 : 90563957;
        ...
        assert(block.hashMerkleRoot == uint256("0xbb6be1a3e8fe08267c3d92f2f0327040bdecc7a7b4508fce733782780ca34d76"));
